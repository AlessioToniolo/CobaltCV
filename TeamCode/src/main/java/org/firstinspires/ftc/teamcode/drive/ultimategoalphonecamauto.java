...
import org.firstinspires.ftc.teamcode.vision.ultimategoalphonecampipeline;
...
//@Disabled
public class ultimategoalphonecamauto extends LinearOpMode {
    ...
    ultimategoalphonecampipeline.SkystoneDeterminationPipeline pipeline;
    ...
    public void runOpMode() {
        ...
        pipeline = new ultimategoalphonecampipeline.SkystoneDeterminationPipeline();
        ...
        public static class SkystoneDeterminationPipeline extends OpenCvPipeline {
            ...
            private volatile ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition position = EasyOpenCVExample.SkystoneDeterminationPipeline.RingPosition.FOUR;
            ...
            public Mat processFrame(Mat input) {
                ...
                position = ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
                if (avg1 > FOUR_RING_THRESHOLD) {
                    position = ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.FOUR;
                } else if (avg1 > ONE_RING_THRESHOLD) {
                    position = ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.ONE;
                } else {
                    position = ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.NONE;
                }
        ...
        if (position == ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.FOUR) {
            telemetry.addData("Target Zone", 'C');
            telemetry.update();
        } else if (position == ultimategoalphonecampipeline.SkystoneDeterminationPipeline.RingPosition.ONE) {
